...
{
    public class InternetHistorySender : IInternetHistorySender
    {
        private readonly EmailConfig _config;
        private readonly IInternetHistoryData _historyData;

        public InternetHistorySender(IOptions<EmailConfig> emailConfigOptions, IInternetHistoryData historyData)
        {
